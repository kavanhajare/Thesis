...
public class ERDB_Ecommerce {
    ...
    public void fetchSchemaData() {
        ...
        String countQueryStatement="select count(*) as count from erql_ecommerce.query";
        ...
        for(int i=1;i<=count;i++){
            ...
            String queryDetailsStatement="select get_entity,predicate_entity,equality_attributes,range_attributes,order_type from erql_ecommerce.query where query_no="+i;
            ...
            if(predicate_table.contains(entity_name)  && !equality_attribute.isEmpty()){
                ...
                String entityStatement="select entity_name from erql_ecommerce.entity_attribute where attribute_name='"+equalityAttribute+"' ALLOW FILTERING";
                ...
                String entityStatement="select entity_name from erql_ecommerce.entity_attribute where attribute_name='"+rangeAttribute+"' ALLOW FILTERING";
                ResultSet resultSet7=session.execute(entityStatement);
            ...
            if(schemaDetails.containsKey(entity_name+"_by_"+predicate_table)){
                ...
                String schemaAttributesStatement="select attribute_name,attribute_type from erql_ecommerce.entity_attribute where entity_name='"+entity_name+"' ALLOW FILTERING";
                ...
                for(Row z:resultSet2.all()) {
                    if(z.getString("attribute_type").equals("composite")){
                        String compositeAttributesStatement="select sub_attribute_name from erql_ecommerce.entity_composite_attribute where attribute_name='"+z.getString("attribute_name")+"' ALLOW FILTERING";
                ...
                if(predicate_table.contains(".")){
                    ...
                    for(int entity=0; entity<predicateEntities.length-1; entity++) {
                        ...
                        String primaryAttributesOfPredicateEntityStatement = "select primary_key from erql_ecommerce.entity where entity_name='" + predicateEntities[entity] + "'";
            ...
            if(!equality_attribute.isEmpty()){
                for(String partitionAttribute:equality_attribute){
                    if(attributesSet.contains(partitionAttribute)){
                        String multivalueAttributeStatement="select multivalue from erql_ecommerce.entity_attribute where attribute_name='"+partitionAttribute+"' allow filtering";
...
//                    predicateEntity =predicateEntities[predicateEntities.length-1];
                    for(String entity:predicateEntities){
                        String primaryAttributesOfPredicateEntityStatement="select primary_key from erql_ecommerce.entity where entity_name='"+entity+"'";
                        ResultSet resultSet4=session.execute(primaryAttributesOfPredicateEntityStatement);
                        Row a=resultSet4.one();
                        String primaryKeyForPredicateEntity=a.getString("primary_key");
                        String[] primaryAttributes=primaryKeyForPredicateEntity.split(",");
                ...
                String primaryAttributesOfPredicateEntityStatement="select primary_key from erql_ecommerce.entity where entity_name='"+predicateEntity+"'";
                ResultSet resultSet4=session.execute(primaryAttributesOfPredicateEntityStatement);
                Row a=resultSet4.one();
                String primaryKeyForPredicateEntity=a.getString("primary_key");
                String[] primaryAttributes=primaryKeyForPredicateEntity.split(",");
...
//            for(String clusteringAttribute:range_attribute) {
//                clusteringKeySet.add(clusteringAttribute + " " + order_type.toUpperCase());
...
//            }
            ...
            String primaryAttributesStatement="select primary_key from erql_ecommerce.entity where entity_name='"+entity_name+"'";
...
//                out.println(clusteringKey);
    ...
    {
        final ERDB_Ecommerce client = new ERDB_Ecommerce();
